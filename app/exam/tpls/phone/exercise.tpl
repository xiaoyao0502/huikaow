			...
			<div class="examform">
				...
				<form action="index.php?exam-phone-exercise" id="exer" method="post">
                	<div class="control-group">
						<label class="control-label" for="inputEmail">科目：</label>
						<div class="controls">
							<select autocomplete="off" name="args[sectionid]" class="combox input-medium" target="questionnumbers" refUrl="index.php?exam-phone-exercise-ajax-getQuestionNumber&sectionid={value}" needle="needle" msg="请选择科目">
