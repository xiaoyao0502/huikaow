						...
						<tr>
							<td class="form-inline">
								...
								<option value="1"{x2;if:$search['questionisrows']} selected{x2;endif}>题帽题</option>
						  		...
						  		<select name="search[questiontype_child]" class="input-medium">
							  		<option value="">选择子题型</option>
							  		<option value="1">综合题</option>
							  		<option value="2">组合选择题</option>
							  		<option value="3">案例分析题</option>
							  		<option value="4">计算分析题</option>
							  	</select>
				...
				<table class="table table-hover">
					...
					<tbody>
				        ...
				        <tr>
				          ...
				          <td>{x2;$questypes[v:question['questiontype']]['questype']}{x2;if:v:question['questiontype_child'] == 1}-综合题{x2;endif}{x2;if:v:question['questiontype_child'] == 2}-组合选择题{x2;endif}{x2;if:v:question['questiontype_child'] == 3}-案例分析题{x2;endif}{x2;if:v:question['questiontype_child'] == 4}-计算分析题{x2;endif}</td>
				          <td>
