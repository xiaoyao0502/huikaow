					...
					<tr>
						...
						<td>
							<select name="search[questiontype]" class="input-medium">
						  		...
						  		{x2;endtree}
						  		<option value="8">综合题</option>
						  		<option value="9">组合选择题</option>
						  		<option value="10">案例分析题</option>
						  		<option value="11">计算分析题</option>
					  		</select>
						</td>
						<td>
							难度：
			            ...
			            <tbody>
					        ...
					        <tr>
								...
								<td>
									...
									{x2;if:v:question['questiontype_child'] == 1}综合题{x2;endif}
									{x2;if:v:question['questiontype_child'] == 2}组合选择题{x2;endif}
									{x2;if:v:question['questiontype_child'] == 3}案例分析题{x2;endif}
									{x2;if:v:question['questiontype_child'] == 4}计算分析题{x2;endif}
								</td>
								<td>
