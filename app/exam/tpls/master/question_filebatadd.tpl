...
{x2;endif}
			...
			<form action="index.php?exam-master-questions-filebataddquestion" method="post" class="form-horizontal" enctype="multipart/form-data">
				...
				<div class="control-group">
					<label for="knowsid" class="control-label">章节ID</label>
					<div class="controls">
						<input type="text" name="knowsid" id="knowsid" value="0"/>
						<span class="help-block">如果您的章节ID和CSV文件中的章节ID不同，请在此填写您希望加入的章节ID，否则请填写0</span>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						...
						<span class="btn">
							<a id="uploadfile" style="display:none" class="uploadbutton" exectype="upfile" uptypes="*.csv">选择文件</a>
							<!-- <input id="uploadfile" name="uploadfile" type="file" class="" exectype="upfile" uptypes="*.csv" /> -->
						</span>
