					...
					<tr>
						...
						<td>
							...
							<select name="search[exam_type]">
								<option value="0">不限</option>
								<option value="1"{x2;if:$search['exam_type'] == 1} selected{x2;endif}>章节测试</option>
								<option value="2"{x2;if:$search['exam_type'] == 2} selected{x2;endif}>押题</option>
							</select>
						</td>
						<td>
							选择课程：
	            ...
	            <tbody>
			        ...
			        <tr>
						...
						<td>
							...
							{x2;if:v:exam['exam_type'] == 1}章节测试{x2;elseif:v:exam['exam_type'] == 2}押题{x2;endif}
						</td>
						<td>
						...
						<td>
							{x2;$knowsList[v:exam['examknowsid']]['knows']}
						</td>
						<td>
							<div class="btn-group">
