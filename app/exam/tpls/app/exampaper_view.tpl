						...
						<div class="media well">
							...
							<div class="media-body well">
		                    	<ul class="unstyled">
		                        	...
		                        	<li class="text-success"><span class="text-info">章节：</span>{x2;tree:v:question['questionknowsid'],knowsid,kid}&nbsp;&nbsp;{x2;$globalknows[v:knowsid['knowsid']]['knows']}&nbsp;{x2;endtree}</li>
							...
							<div class="paperexamcontent decidediv">
								...
								<div class="media-body well">
									<ul class="unstyled">
			                        	...
			                        	<li><span class="text-info">章节：</span>{x2;tree:v:questionrow['qrknowsid'],knowsid,kid}&nbsp;&nbsp;{x2;$globalknows[v:knowsid['knowsid']]['knows']}&nbsp;{x2;endtree}</li>
			                        	<li class="text-info">答案解析：</li>
