 ...
 $qid++; ?>
				        <tr>
				          ...
				          <td><?php echo $this->tpl_var['questypes'][$question['questiontype']]['questype']; ?><?php if($question['questiontype_child'] == 1){ ?>-综合题<?php } ?><?php if($question['questiontype_child'] == 2){ ?>-组合选择题<?php } ?><?php if($question['questiontype_child'] == 3){ ?>-案例分析题<?php } ?><?php if($question['questiontype_child'] == 4){ ?>-计算分析题<?php } ?></td>
				          <td>
