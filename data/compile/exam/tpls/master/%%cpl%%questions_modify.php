			...
			<form action="index.php?exam-master-questions-modifyquestion" method="post" class="form-horizontal">
				...
				<div class="control-group">
					<label class="control-label">章节：</label>
				  	<div class="controls">
				  		<textarea class="input-xxlarge" rows="4" needle="needle" min="1" msg="您最少需要选定一个章节" name="args[questionknowsid]" id="questionknowsid" readonly><?php $kid = 0;
					...
					<label class="control-label">所属子题型：</label>
				  	<div class="controls">
					  	<select name="args[questiontype_child]" class="combox">
					  		<option value="0" rel="0"<?php if($this->tpl_var['question']['questiontype_child'] == 0){ ?> selected<?php } ?>>请选择</option>
					  		<option value="1" rel="1"<?php if($this->tpl_var['question']['questiontype_child'] == 1){ ?> selected<?php } ?>>综合题</option>
					  		<option value="2" rel="2"<?php if($this->tpl_var['question']['questiontype_child'] == 2){ ?> selected<?php } ?>>组合选择题</option>
					  		<option value="3" rel="3"<?php if($this->tpl_var['question']['questiontype_child'] == 3){ ?> selected<?php } ?>>案例分析题</option>
					  		<option value="4" rel="4"<?php if($this->tpl_var['question']['questiontype_child'] == 4){ ?> selected<?php } ?>>计算分析题</option>
					  	</select>
					</div>
				</div>
				<div class="control-group">
