<div class="navbar navbar-inverse">
	<div class="navbar-inner">
		<div class="container-fluid">
			...
			<a href="index.php" target="_blank" class="brand"><img src="app/core/styles/images/favicon.png"><?php echo $this->tpl_var['apps']['core']['appsetting']['seo']['title']; ?>系统管理平台<span class="label">Version:<?php echo PE_VERSION; ?></span></a>
