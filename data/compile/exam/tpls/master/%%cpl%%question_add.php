			...
			<form action="index.php?exam-master-questions-addquestion" method="post" class="form-horizontal">
				...
				<div class="control-group">
					<label class="control-label">章节：</label>
				  	<div class="controls">
				  		<textarea class="input-xxlarge" rows="4" needle="needle" min="1" msg="您最少需要选定一个章节" name="args[questionknowsid]" id="questionknowsid" readonly></textarea>
					</div>
				</div>
				<div class="control-group">
			  		<div class="controls">
 ...
 $qid++; ?>
					...
					<label class="control-label">所属子题型：</label>
				  	<div class="controls">
					  	<select name="args[questiontype_child]" class="combox">
					  		...
					  		<option value="1" rel="1">综合题</option>
					  		<option value="2" rel="2">组合选择题</option>
					  		<option value="3" rel="3">案例分析题</option>
					  		<option value="4" rel="4">计算分析题</option>
					  	</select>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">题干：</label>
				  	<div class="controls">
					  	...
					  	<span class="help-block red_note">需要填空处请以()表示。</span>
					</div>
				</div>
				<div class="control-group" id="selecttext">
					<label class="control-label">备选项：</label>
				  	<div class="controls">
					  	...
					  	<span class="help-block red_note">每个选择项回车换行，无选择项的请不要填写，如填空题、问答题等主观题。</span>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<div id="answerbox_6" style="display:none;" class="answerbox">
					  		<textarea cols="72" rows="7" class="ckeditor" id="questionanswer6" name="targs[questionanswer6]"><?php echo $this->tpl_var['question']['questionanswer']; ?></textarea>
						</div>
