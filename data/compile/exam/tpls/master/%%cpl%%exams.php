				...
				<table class="table">
					...
					<tr>
						...
						<td>
							...
							<select name="search[exam_type]">
								<option value="0">不限</option>
								<option value="1"<?php if($this->tpl_var['search']['exam_type'] == 1){ ?> selected<?php } ?>>章节测试</option>
								<option value="2"<?php if($this->tpl_var['search']['exam_type'] == 2){ ?> selected<?php } ?>>押题</option>
							</select>
						</td>
						<td>
							选择课程：
 ...
 $eid++; ?>
			        <tr>
						...
						<td>
							...
							<?php if($exam['exam_type'] == 1){ ?>章节测试<?php } elseif($exam['exam_type'] == 2){ ?>押题<?php } ?>
						</td>
						<td>
						...
						<td>
							<?php echo $this->tpl_var['knowsList'][$exam['examknowsid']]['knows']; ?>
						</td>
						<td>
							<div class="btn-group">
