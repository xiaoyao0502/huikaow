<div class="accordion" id="accordion-13465">
		...
		<div class="accordion-body<?php if($this->tpl_var['method'] == 'basic'){ ?> in<?php } ?> collapse" id="accordion-element-707348">
			<div class="accordion-inner">
				<ul class="unstyled">
		    		...
		    		<li><a href="?<?php echo $this->tpl_var['_app']; ?>-master-basic-subject">课程管理</a></li>
	...
	<div class="accordion-group">
		...
		<div class="accordion-body<?php if($this->tpl_var['method'] == 'questions' || $this->tpl_var['method'] == 'rowsquestions' || $this->tpl_var['method'] == 'basic'){ ?> in<?php } ?> collapse" id="accordion-element-212076">
			<div class="accordion-inner">
				<ul class="unstyled">
		    		<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-basic-subject">课程管理</a></li>
		...
		<div class="accordion-body<?php if($this->tpl_var['method'] == 'exams'){ ?> in<?php } ?> collapse" id="accordion-element-212096">
			<div class="accordion-inner">
				<ul class="unstyled">
					...
					<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-exams-selfpage">章节组卷</a></li>
		...
		<div class="accordion-body<?php if($this->tpl_var['method'] == 'recyle'){ ?> in<?php } ?> collapse" id="accordion-element-212090">
			<div class="accordion-inner">
				<ul class="unstyled">
					...
					<!-- <li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-recyle-rows">题帽题</a></li> -->
					<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-recyle-knows">章节</a></li>
				</ul>
			</div>
		</div>
	</div>
