...
<?php } ?>
	        ...
	        <form action="index.php?exam-master-basic-modifyquestype" method="post" class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input name="args[questchar]" id="questype" type="text" size="30" value="<?php echo $this->tpl_var['quest']['questchar']; ?>" needle="needle" alt="请输入题型识别码" />
					</div>
				</div>
				-->
				<div class="control-group">
					...
					<div class="controls">
						<select class="combox" name="args[questchoice]" id="questchoice">
							<option value="1"<?php if($this->tpl_var['quest']['questchoice']==1){ ?> selected<?php } ?>>单选</option>
	  						...
	  						<option value="6"<?php if($this->tpl_var['quest']['questchoice']==5){ ?> selected<?php } ?>>定值连线题</option>
						</select>
